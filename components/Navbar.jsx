'use client'; // Coz useState is used
import Image from 'next/image'; // From Next.js
import logo from '@/assets/images/logo-white.png'; // To import the logo (white)
import profileDefault from '@/assets/images/profile.png'; // To import the profile default image
        ...
        <div className='relative flex h-20 items-center justify-between'>
          <div className='absolute inset-y-0 left-0 flex items-center md:hidden'>
            ...
            <button
              ...
              aria-expanded='false'
              onClick={() => setIsMobileMenuOpen((prev) => !prev)}  // To toggle the state between true and false
            >
          ...
          {!session && (
            <div className='hidden md:block md:ml-6'>
              <div className='flex items-center'>
                {providers &&
                    Object.values(providers).map((provider) => (  // To loop through all providers (here just Google is used)
                      <button
                        key={provider.name}
